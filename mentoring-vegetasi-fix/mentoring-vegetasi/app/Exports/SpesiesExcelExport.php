...
class SpesiesExcelExport implements FromCollection, WithHeadings, WithStyles, WithCustomStartCell, WithMapping
{
    ...
    public function map($spesies): array
    {
        ...
        return [
            ...
            $spesies->longitude,
            $spesies->deskripsi,
            $spesies->genus->nama_genus,
            $spesies->wilayahs->name,
            $spesies->vegetasis->nama_vegetasi,
            $spesies->foto,
        ];
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('B5:N5')->applyFromArray([
            'font' => [
                'bold' => true,
            ],
            'alignment' => [
        ...
        $sheet->getStyle('B2:N' . $lastRow)->applyFromArray([
            'borders' => [
                'allBorders' => [
